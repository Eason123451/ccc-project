...
def plot_crime_sentiment_url(port):
    # Retrieve data
    crime_data = get_url_data(port, 'search-viccrime-for-twitter')
    ...
    ax = sns.regplot(x='Crime_Count', y='Sentiment', data=data_merged, scatter_kws={'alpha':0.5}, line_kws={'color':'red', 'label': 'Fit line'})
